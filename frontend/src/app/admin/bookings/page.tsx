...
export default function AdminBookingsPage() {
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold mb-8">Rezervasyon Yönetimi</h1>
        ...
        <table className="w-full text-left whitespace-nowrap">
          <thead className="bg-gray-50 dark:bg-zinc-800/50">
            <tr>
              ...
              <th className="p-4 font-medium text-zinc-500 text-sm">Misafir</th>
              <th className="p-4 font-medium text-zinc-500 text-sm">Oda</th>
              <th className="p-4 font-medium text-zinc-500 text-sm">Tarihler</th>
              <th className="p-4 font-medium text-zinc-500 text-sm">Durum</th>
          ...
          <tbody>
            {bookings.map((booking) => (
              <tr key={booking.id} className="border-t border-gray-100 dark:border-zinc-800">
                ...
                <td className="p-4 text-sm">{booking.room?.name || 'Silinmiş Oda'}</td>
             ...
             {bookings.length === 0 && (
              <tr>
                <td colSpan={6} className="p-8 text-center text-zinc-500">Rezervasyon bulunamadı.</td>
              </tr>
            )}
          </tbody>
        </table>
