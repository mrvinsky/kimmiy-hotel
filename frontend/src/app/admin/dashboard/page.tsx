    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white dark:bg-zinc-900 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-zinc-800 flex items-center">
          ...
          <div>
            <h3 className="text-sm font-medium text-zinc-500">Bekleyen Rezervasyonlar</h3>
        ...
        <div className="bg-white dark:bg-zinc-900 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-zinc-800 flex items-center">
          ...
          <div>
            <h3 className="text-sm font-medium text-zinc-500">Toplam Oda</h3>
         ...
         <div className="bg-white dark:bg-zinc-900 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-zinc-800 flex items-center">
          ...
          <div>
            <h3 className="text-sm font-medium text-zinc-500">Ziyaretçiler</h3>
            <p className="text-sm text-zinc-400">Analiz entegrasyonu bekleniyor</p>
          </div>
        </div>
      </div>
    </div>
